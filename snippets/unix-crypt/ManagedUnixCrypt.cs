...
/// </summary>
/// <remarks>
/// The code is taken from https://gist.github.com/ygoe/33832285434eac3dc299a2b821470d19 and
/// is based on https://github.com/ahall/PasswordSharp, which is based on
/// https://gist.github.com/otac0n/1092558 and adds SHA-512 support. This is an implementation
/// of the crypt format (see https://man7.org/linux/man-pages/man3/crypt.3.html) described in http://www.akkadia.org/drepper/SHA-crypt.txt. The code has
...
public static class ManagedUnixCrypt
{
    ...
    public static string GenerateSalt(string algoType = DefaultType, int rounds = RoundsDefault)
    {
        ...
        var randomBytes = RandomNumberGenerator.GetBytes(saltByteCount);
        string roundsParam = "";
